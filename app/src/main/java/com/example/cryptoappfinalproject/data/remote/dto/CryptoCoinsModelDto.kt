...
abstract class CryptoCoinsModelDto : MutableList<CryptoCoinsModelDto.CryptoCoinsModelItem>{
    @Parcelize
...
fun CryptoCoinsModelDto.CryptoCoinsModelItem.toCryptoCoinsModel(): CryptoCoinsModel.CryptoCoinsModelItem {
    return CryptoCoinsModel.CryptoCoinsModelItem (
        name = name,
